 ...
 * 2.create a checkout form with cart element (cart element contains : cart number, expiration data, cvs, zip code)
 * 3. create account on stripe and get the publihsable key
 ...
 * make sure you provide ammount in cents (multipy price with 100)
